...
print(f"The number of guests invited to the dinner is: {len(guest_list)}\n")
...
print(f"{message} {guest_list[1]}.") # Khada Jhin
print(f"{message} {guest_list[2]}.") # Karely
print(f"{message} {guest_list[3]}.") # Aaron Griffin
print(f"{message} {guest_list[4]}.") # Hatsune Miku
print(f"{message} {guest_list[5]}.") # Noodle
print(f"{message} {guest_list[6]}.") # Geralt of Rivia
print(f"The number of guests invited to the dinner is: {len(guest_list)}\n")
...
print(f"I'm sorry, {uninvited}, but you can't come to dinner tonight.")
